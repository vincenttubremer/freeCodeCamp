...
--
-- Name: elements unique_name_id; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements unique_symbol_id; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_symbol_id UNIQUE (symbol);
